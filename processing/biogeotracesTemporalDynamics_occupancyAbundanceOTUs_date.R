...
ggsave("seanSeqsNoProSyn_biogeotracesSamplesWithOccupancyAbundanceOTUs_byDateBATS.png", dpi = 600, height = 10, width = 20)
ggsave("seanSeqsNoProSyn_biogeotracesSamplesWithOccupancyAbundanceOTUs_byDateBATS.svg", dpi = 600, height = 10, width = 20)
...
ggsave("seanSeqsNoProSyn_biogeotracesSamplesWithOccupancyAbundanceOTUs_byDateHOT.png", dpi = 600, height = 10, width = 20)
ggsave("seanSeqsNoProSyn_biogeotracesSamplesWithOccupancyAbundanceOTUs_byDateHOT.svg", dpi = 600, height = 10, width = 20)
