...
#the number of biogeotraces samples in each HOT and BATS in each year
ubiSummary %>% head()
...
ggsave("seanSeqsNoProSyn_biogeotracesSamplesWithUbiquitousOTUs_byYearBATS.png", dpi = 600, height = 10, width = 20)
ggsave("seanSeqsNoProSyn_biogeotracesSamplesWithUbiquitousOTUs_byYearBATS.svg", dpi = 600, height = 10, width = 20)
...
ggsave("seanSeqsNoProSyn_biogeotracesSamplesWithUbiquitousOTUs_byYearHOT.png", dpi = 600, height = 10, width = 20)
ggsave("seanSeqsNoProSyn_biogeotracesSamplesWithUbiquitousOTUs_byYearHOT.svg", dpi = 600, height = 10, width = 20)
